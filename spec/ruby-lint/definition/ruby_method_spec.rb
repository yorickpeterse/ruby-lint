...
describe RubyLint::Definition::RubyObject do
  context 'method definition DSL' do
    ...
    context 'return values' do
      ...
      it 'returns a value using a block' do
        @method.returns do
          20
        end
    ...
    context 'calling methods' do
      ...
      it 'calls the method directly' do
        @method.call.should == 10
      end

      it 'calls the method by name' do
      ...
      it 'raises for calling an undefined method' do
        container = ruby_object.new(
          :name          => 'String',
          :type          => :const,
          :instance_type => :instance
    ...
    context 'defining arguments' do
      ...
      it 'defines a block argument' do
      ...
      it 'defines a keyword argument' do
