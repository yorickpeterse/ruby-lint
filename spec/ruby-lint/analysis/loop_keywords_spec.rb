...
describe RubyLint::Analysis::LoopKeywords do
  context 'next' do
    it 'errors when using next outside of a loop' do
    ...
    it 'does not error when using next in a loop' do
      code   = '[].each { next }'
    ...
    it 'does not error when using next inside a while loop' do
    ...
    it 'does not error when using next inside an until loop' do
    ...
    it 'does not error when using next inside a for loop' do
    ...
    it 'does not error when using next inside a loop loop' do
      code   = 'loop { next }'
      report = build_report(code, described_class)
  ...
  context 'break' do
    it 'errors when using break outside of a loop' do
    ...
    it 'does not error when using break in a loop' do
      code   = '[].each { break }'
      report = build_report(code, described_class)
    ...
    it 'does not error when using break inside a while loop' do
    ...
    it 'does not error when using break inside a for loop' do
    ...
    it 'does not error when using break inside a loop loop' do
      code   = 'loop { break }'
      report = build_report(code, described_class)
