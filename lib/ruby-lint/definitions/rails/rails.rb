...
RubyLint.registry.register('Rails') do |defs|
  ...
  defs.define_constant('Rails::Initializable::Collection') do |klass|
    klass.inherits(defs.constant_proxy('Array'))
  ...
  defs.define_constant('Rails::Initializable::Collection::Cyclic') do |klass|
    klass.inherits(defs.constant_proxy('StandardError'))

  end

  defs.define_constant('Rails::Initializable::Collection::Enumerator') do |klass|
    klass.inherits(defs.constant_proxy('Object'))
  ...
  defs.define_constant('Rails::Initializable::Collection::SortedElement') do |klass|
    klass.inherits(defs.constant_proxy('Object'))
  ...
  defs.define_constant('Rails::Railtie::Configurable') do |klass|
    klass.inherits(defs.constant_proxy('Object'))
  ...
  defs.define_constant('Rails::Railtie::Configurable::ClassMethods') do |klass|
    klass.inherits(defs.constant_proxy('Object'))
