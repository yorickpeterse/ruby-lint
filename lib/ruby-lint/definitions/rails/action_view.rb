...
RubyLint.registry.register('ActionView') do |defs|
  ...
  defs.define_constant('ActionView::Base') do |klass|
    klass.inherits(defs.constant_proxy('Object'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::TranslationHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::RenderingHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::RecordTagHelper'))
    klass.inherits(defs.constant_proxy('ActionView::RecordIdentifier'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::FormHelper'))
    klass.inherits(defs.constant_proxy('ActionView::ModelNaming'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::OutputSafetyHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::NumberHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::JavaScriptHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::FormOptionsHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::FormTagHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::TextHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::DebugHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::SanitizeHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::CacheHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::AtomFeedHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::UrlHelper'))
    ...
    klass.inherits(defs.constant_proxy('ActionView::Helpers::ActiveModelHelper'))
    ...
    klass.inherits(defs.constant_proxy('ActionView::Helpers::DateHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::CsrfHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::ControllerHelper'))
    klass.inherits(defs.constant_proxy('ActionView::Helpers::CaptureHelper'))
    klass.inherits(defs.constant_proxy('ERB::Util'))
    klass.inherits(defs.constant_proxy('ActionView::Context'))
    klass.inherits(defs.constant_proxy('ActionView::CompiledTemplates'))
    klass.inherits(defs.constant_proxy('ActiveSupport::Dependencies::Loadable'))
    klass.inherits(defs.constant_proxy('JSON::Ext::Generator::GeneratorMethods::Object'))
  ...
  defs.define_constant('ActionView::LookupContext') do |klass|
    klass.inherits(defs.constant_proxy('Object'))
    klass.inherits(defs.constant_proxy('ActionView::LookupContext::ViewPaths'))
    klass.inherits(defs.constant_proxy('ActionView::LookupContext::DetailsCache'))
    klass.inherits(defs.constant_proxy('ActionView::LookupContext::Accessors'))
    klass.inherits(defs.constant_proxy('ActiveSupport::Dependencies::Loadable'))
    klass.inherits(defs.constant_proxy('JSON::Ext::Generator::GeneratorMethods::Object'))
  ...
  defs.define_constant('ActionView::Resolver::Cache::SmallCache::Node') do |klass|
    klass.inherits(defs.constant_proxy('Object'))
    klass.inherits(defs.constant_proxy('ThreadSafe::Util::CheapLockable'))
  ...
  defs.define_constant('ActionView::Template::Handlers::Erubis') do |klass|
    ...
    klass.inherits(defs.constant_proxy('Erubis::RubyGenerator'))
    klass.inherits(defs.constant_proxy('Erubis::StringBufferEnhancer'))
    klass.inherits(defs.constant_proxy('Erubis::RubyEvaluator'))
    klass.inherits(defs.constant_proxy('Erubis::Generator'))
    klass.inherits(defs.constant_proxy('Erubis::Basic::Converter'))
    klass.inherits(defs.constant_proxy('Erubis::Converter'))
    klass.inherits(defs.constant_proxy('Erubis::Evaluator'))
    klass.inherits(defs.constant_proxy('ActiveSupport::Dependencies::Loadable'))
    klass.inherits(defs.constant_proxy('JSON::Ext::Generator::GeneratorMethods::Object'))
  ...
  defs.define_constant('ActionView::TestCase') do |klass|
    ...
    klass.inherits(defs.constant_proxy('ActionView::TestCase::Behavior'))
    klass.inherits(defs.constant_proxy('ActionView::RoutingUrlFor'))
    klass.inherits(defs.constant_proxy('ActionDispatch::Routing::UrlFor'))
