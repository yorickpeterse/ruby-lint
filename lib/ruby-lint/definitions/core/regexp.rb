...
#
RubyLint::GlobalScope.definitions.define_constant('Regexp') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::CAPTURE_GROUP') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::DONT_CAPTURE_GROUP') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::ESCAPE_TABLE') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::EXTENDED') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::FIXEDENCODING') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::IGNORECASE') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::KCODE_EUC') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::KCODE_MASK') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::KCODE_NONE') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::KCODE_SJIS') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::KCODE_UTF8') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::MULTILINE') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::NOENCODING') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::OPTION_MASK') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::SourceParser') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::SourceParser::LookAheadGroupPart') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Regexp::SourceParser::Part'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::SourceParser::LookAheadGroupPart::OPTIONS_MAP') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::SourceParser::OptionsGroupPart') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Regexp::SourceParser::Part'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::SourceParser::OptionsGroupPart::OPTIONS_MAP') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::SourceParser::Part') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Regexp::SourceParser::Part::OPTIONS_MAP') do |klass|
end
