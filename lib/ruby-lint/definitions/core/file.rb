...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::APPEND') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::BINARY') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::BidirectionalPipe') do |klass|
  klass.inherits(RubyLint.global_constant('IO'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::CREAT') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Constants') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::EAGAINWaitReadable') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::EAGAINWaitWritable') do |klass|
  klass.inherits(RubyLint.global_constant('Errno::EAGAIN'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::EXCL') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::EachReader') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::FFI') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::F_GETFL') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::FileError') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::InternalBuffer') do |klass|
  klass.inherits(RubyLint.global_constant('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::LOCK_UN') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::NOCTTY') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::NONBLOCK') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::NULL') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::NoFileError') do |klass|
  klass.inherits(RubyLint.global_constant('File::FileError'))
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::PATH_SEPARATOR') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::POSIX') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::PermissionError') do |klass|
  klass.inherits(RubyLint.global_constant('File::FileError'))
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::SEEK_CUR') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::SEEK_END') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::SEPARATOR') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::SYNC') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Socketable') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::SortedElement') do |klass|
  klass.inherits(RubyLint.global_constant('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat') do |klass|
  klass.inherits(RubyLint.global_constant('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::EXISTS_STRUCT') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IFBLK') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IFCHR') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IFDIR') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IFIFO') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IFLNK') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IFMT') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IFREG') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IFSOCK') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IRGRP') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IRUGO') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IWGRP') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IWUGO') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::S_IXUGO') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::Struct') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::Struct::InlineArray') do |klass|
  klass.inherits(RubyLint.global_constant('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::Stat::Struct::InlineCharArray') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::StreamCopier') do |klass|
  klass.inherits(RubyLint.global_constant('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::TRUNC') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::TransferIO') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::UnableToStat') do |klass|
  klass.inherits(RubyLint.global_constant('File::FileError'))
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::WaitReadable') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('File::WaitWritable') do |klass|
end