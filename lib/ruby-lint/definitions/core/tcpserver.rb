...
RubyLint::GlobalScope.definitions.define_constant('TCPServer') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('TCPSocket'))
...
RubyLint::GlobalScope.definitions.lookup(:const, 'TCPServer').deep_freeze
