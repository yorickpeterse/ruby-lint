...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::BadAlias') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Exception'))
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Coder') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::DEPRECATED') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::DeprecatedMethods') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::ENGINE') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Emitter') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Handler'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Exception') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Handler') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Handlers') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Handlers::DocumentStream') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::TreeBuilder'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::JSON') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::JSON::RubyEvents') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::JSON::Stream') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Visitors::JSONTree'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::JSON::Stream::DISPATCH') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::JSON::Stream::Emitter') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Stream::Emitter'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::JSON::TreeBuilder') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::TreeBuilder'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::JSON::YAMLEvents') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::LIBYAML_VERSION') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Alias') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Nodes::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Alias::SortedElement') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Document') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Nodes::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Document::SortedElement') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Mapping') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Nodes::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Mapping::BLOCK') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Mapping::FLOW') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Mapping::SortedElement') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Node') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Node::SortedElement') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Scalar') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Nodes::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Scalar::DOUBLE_QUOTED') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Scalar::FOLDED') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Scalar::LITERAL') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Scalar::PLAIN') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Scalar::SINGLE_QUOTED') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Scalar::SortedElement') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Sequence') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Nodes::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Sequence::BLOCK') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Sequence::FLOW') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Sequence::SortedElement') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Stream') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Nodes::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Stream::SortedElement') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Stream::UTF16BE') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Stream::UTF16LE') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Nodes::Stream::UTF8') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Omap') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Omap::Bucket') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Omap::Entries') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Omap::Iterator') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Omap::MAX_ENTRIES') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Omap::MIN_SIZE') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Omap::SortedElement') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Omap::State') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Parser') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Parser::Mark') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('#<Class:0x16848>'))
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Parser::Mark::Group') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Parser::Mark::Passwd') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Rubinius::FFI::Struct'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Parser::Mark::STRUCT_ATTRS') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Parser::Mark::SortedElement') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Parser::Mark::Tms') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Parser::UTF16BE') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Parser::UTF16LE') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Parser::UTF8') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::PrivateType') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::ScalarScanner') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::ScalarScanner::FLOAT') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::ScalarScanner::TIME') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Set') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Hash'))
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Set::Bucket') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Set::Entries') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Set::Iterator') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Set::MAX_ENTRIES') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Set::MIN_SIZE') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Set::SortedElement') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Set::State') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Stream') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Stream::DISPATCH') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Stream::Emitter') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Emitter'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Streaming') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::SyntaxError') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('SyntaxError'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::TreeBuilder') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Handler'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::VERSION') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors::DepthFirst') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Visitors::Visitor'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors::DepthFirst::DISPATCH') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors::Emitter') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Visitors::Visitor'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors::Emitter::DISPATCH') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors::JSONTree') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Visitors::YAMLTree'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors::JSONTree::DISPATCH') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors::ToRuby') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Visitors::Visitor'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors::ToRuby::DISPATCH') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors::Visitor') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors::Visitor::DISPATCH') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors::YAMLTree') do |klass|
  klass.inherits(RubyLint::GlobalScope.constant_proxy('Psych::Visitors::Visitor'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint::GlobalScope.definitions.define_constant('Psych::Visitors::YAMLTree::DISPATCH') do |klass|
end