...
RubyLint.registry.register('IRB') do |defs|
  ...
  defs.define_constant('IRB::Notifier::D_NOMSG') do |klass|
    ...
    klass.define_method('exec_if')

    klass.define_method('level')

    klass.define_method('notify?')

    klass.define_method('pp') do |method|
      method.define_rest_argument('objs')
    end

    klass.define_method('ppx') do |method|
      method.define_argument('prefix')
      method.define_rest_argument('objs')
    end
    ...
    klass.define_method('printn') do |method|
      method.define_rest_argument('opts')
    end
  ...
  defs.define_constant('IRB::SLex::DOUT') do |klass|
    ...
    klass.define_method('level_notifier')

    klass.define_method('level_notifier=') do |method|
      method.define_argument('value')
    end

    klass.define_method('notifiers')
