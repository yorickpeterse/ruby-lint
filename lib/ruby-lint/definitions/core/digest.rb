...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Digest::Base') do |klass|
  klass.inherits(RubyLint.global_constant('Digest::Class'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Digest::Class') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Digest::Instance') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Digest::SHA2') do |klass|
  klass.inherits(RubyLint.global_constant('Digest::Class'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Digest::SHA256') do |klass|
  klass.inherits(RubyLint.global_constant('Digest::Base'))
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Digest::SHA384') do |klass|
  klass.inherits(RubyLint.global_constant('Digest::Base'))
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Digest::SHA512') do |klass|
  klass.inherits(RubyLint.global_constant('Digest::Base'))
end