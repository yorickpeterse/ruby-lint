...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::FFI') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob') do |klass|
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::ConstantDirectory') do |klass|
  klass.inherits(RubyLint.global_constant('Dir::Glob::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::ConstantEntry') do |klass|
  klass.inherits(RubyLint.global_constant('Dir::Glob::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::ConstantSuffixEntry') do |klass|
  klass.inherits(RubyLint.global_constant('Dir::Glob::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::DirectoriesOnly') do |klass|
  klass.inherits(RubyLint.global_constant('Dir::Glob::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::DirectoryMatch') do |klass|
  klass.inherits(RubyLint.global_constant('Dir::Glob::Match'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::EntryMatch') do |klass|
  klass.inherits(RubyLint.global_constant('Dir::Glob::Match'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::Environment') do |klass|
  klass.inherits(RubyLint.global_constant('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::Match') do |klass|
  klass.inherits(RubyLint.global_constant('Dir::Glob::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::Node') do |klass|
  klass.inherits(RubyLint.global_constant('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::RecursiveDirectories') do |klass|
  klass.inherits(RubyLint.global_constant('Dir::Glob::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::RootDirectory') do |klass|
  klass.inherits(RubyLint.global_constant('Dir::Glob::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::StartRecursiveDirectories') do |klass|
  klass.inherits(RubyLint.global_constant('Dir::Glob::Node'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::Glob::SuffixEntryMatch') do |klass|
  klass.inherits(RubyLint.global_constant('Dir::Glob::Match'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::RewindKind') do |klass|
end
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::SortedElement') do |klass|
  klass.inherits(RubyLint.global_constant('Object'))
...
# Platform: rbx 2.0.0.rc1
#
RubyLint.global_scope.define_constant('Dir::TellKind') do |klass|
end